...
reflex update_monthly_data when: 
    all_match(vessel, empty(each.current_id_grid) or each.current_grid_index >= length(each.current_id_grid)) {
...
reflex debug {
 ...
 // reflex stop_simulation when: cycle = 359 {
//     do pause;
//    write "End of December reached. Simulation finished.";
//}
...
//        monitor "Day in month" value: day_in_month; // ((cycle mod 30) = 0) ? 30 : (cycle mod 30);
